...
http.createServer(async(req,res)=>{
 ...
 const path=new URL(req.url,'http://localhost').pathname;const files={'/':'index.html','/app.js':'app.js','/app.css':'app.css','/editor.html':'editor.html','/editor.js':'editor.js','/proposal.css':'proposal.css','/defaults.json':'defaults.json'};
